...
image: 'https://images.unsplash.com/photo-1647427017067-8f33ccbae493?q=80&w=1770&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'  # Reemplazar con la URL de la imagen correspondiente
tags: [comprobantes electronicos, facturacion, costa rica]
---

# ¿Qué son los comprobantes electrónicos?

Un comprobante electrónico es un documento en formato XML que respalda la venta de productos o servicios, autorizado por la Administración Tributaria de Costa Rica (Ministerio de Hacienda).

Un documento XML (Extensible Markup Language / Lenguaje de Marcas Extensibles) es un formato universal que permite el intercambio de información entre distintas plataformas.
...
Algunos de los beneficios de usar FacturacionApp son:

- Menos papel, menos impresiones ¡y menos gasto!
- Nunca volverás a perder tus documentos, ¡todo estará en la nube!
- Almacenamiento automático 100% digital.
- Emitirás las facturas en menos de 1 minuto con tan solo unos cuantos clics.
...
- (FE) Factura Electrónica: respalda la venta de bienes y prestación de servicios de una empresa.
- (FEE) Factura Electrónica Exportación: es emitido y usado tanto para la exportación de mercancías como para la prestación de servicios o venta de bienes intangibles que se realicen en el territorio nacional hacia el extranjero.
- (FEC) Factura Electrónica Compra: lo emite el comprador de un bien o servicio con la finalidad de respaldar su compra. Normalmente, se lleva a cabo cuando el vendedor o prestador de servicios no está obligado a la emisión de comprobantes electrónicos.
- (TE) Tiquete Electrónico: es entregado o transmitido en el instante de la compraventa o prestación de servicios y está autorizado únicamente para operaciones con consumidores finales, por lo cual no puede ser empleado para justificación de gastos o créditos.
- (NC) Nota de Crédito y (ND) Nota de Débito: permiten modificar o anular los efectos contables de la factura electrónica o tiquete electrónico, sin alterar la información del documento original. 
