...
const seoPage = getPortfolioPage('fitpro');

if (!seoPage) {
  throw new Error('FitPro landing data is missing.');
}
...
const benefits = [
  {
    ...
    description: 'Controla membresías, pagos y asistencia desde un solo panel.',
  },
  {
  ...
  },
  {
    ...
    description: 'Agenda clases, verifica accesos y acelera la atención en recepción.',
  },
];
...
const features = [
  ...
  'Panel web para supervisión administrativa.',
];

const useCases = [
  {
    title: 'Gimnasios',
    description: 'Control de acceso, membresías activas y seguimiento de cobros recurrentes.',
  },
  {
    title: 'Estudios boutique',
    description: 'Gestión de cupos por clase, horarios y asistencia por instructor.',
  },
  {
    title: 'Centros de entrenamiento',
    description: 'Visibilidad de indicadores operativos para decisiones diarias más rápidas.',
  },
];

const faqs = [
  {
    q: '¿Qué tipo de negocio puede usar FitPro?',
    a: 'Gimnasios, centros fitness, estudios de entrenamiento y negocios con membresías o clases.',
  },
  {
    q: '¿FitPro permite controlar pagos y vencimientos?',
    a: 'Sí. El sistema facilita el seguimiento de membresías activas, vencidas y cobros pendientes.',
  },
  {
    q: '¿Se puede usar para administrar clases?',
    a: 'Sí. Puedes organizar horarios, cupos y asistencia para mejorar la operación diaria.',
  },
  {
    q: '¿Cómo solicito una demo?',
    a: 'Desde esta página puedes ir directo a FitPro o escribirnos por WhatsApp para coordinar una presentación.',
  },
];
    ...
    <>
      ...
      <section className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
          ...
          <div className="relative grid items-center gap-8 lg:grid-cols-[1.05fr_0.95fr]">
            <div>
              <span className="inline-flex rounded-full border border-emerald-200 bg-white px-3 py-1 text-xs font-semibold text-emerald-800 dark:border-emerald-800 dark:bg-slate-800 dark:text-emerald-300">
                FitPro • Gestión para gimnasios y centros fitness
              </span>
              <h1 className="mt-4 text-3xl font-extrabold tracking-tight text-gray-900 sm:text-5xl dark:text-white">
                Organiza tu gimnasio, mejora cobros y acelera tu operación diaria
              </h1>
              <p className="mt-4 max-w-2xl text-base text-gray-600 sm:text-lg dark:text-slate-300">
                FitPro te ayuda a administrar clientes, membresías, clases y pagos en una sola plataforma, con enfoque
                en control operativo y crecimiento sostenible.
              </p>
              ...
              <div className="mt-5 grid gap-2 text-sm text-gray-700 dark:text-slate-300 sm:grid-cols-2">
                <p className="rounded-lg border border-emerald-100 bg-white/80 px-3 py-2 dark:border-slate-700 dark:bg-slate-800/80">
                  Membresías y renovaciones centralizadas
                </p>
                <p className="rounded-lg border border-emerald-100 bg-white/80 px-3 py-2 dark:border-slate-700 dark:bg-slate-800/80">
            ...
            <div className="rounded-2xl border border-emerald-100 bg-white/95 p-5 shadow-md dark:border-slate-700 dark:bg-slate-900/95">
              <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Indicadores que podrás monitorear</h2>
              <div className="mt-4 grid gap-3 sm:grid-cols-2">
                <div className="rounded-lg bg-emerald-50 px-4 py-3 dark:bg-slate-800">
                  <p className="text-xs uppercase tracking-wide text-emerald-700 dark:text-emerald-300">Membresías</p>
                ...
                <div className="rounded-lg bg-emerald-50 px-4 py-3 dark:bg-slate-800">
                  ...
                  <p className="mt-1 text-xl font-bold text-gray-900 dark:text-white">Cupos y ocupación</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mt-12 grid gap-6 lg:grid-cols-2">
          ...
          <article className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-slate-700 dark:bg-slate-800">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white">¿Para qué tipo de negocio?</h2>
        ...
        <div id="contacto-fitpro" className="mt-12 grid gap-4">
          <article className="flex flex-col items-start justify-between gap-4 rounded-xl bg-emerald-700 p-6 text-white md:flex-row md:items-center">
            <div>
              ...
              <p className="mt-1 text-sm text-emerald-50">Escríbenos para coordinar demo, implementación y soporte.</p>
            </div>
            <a
              ...
              data-analytics-label="FitPro contacto WhatsApp"
          ...
          <article className="rounded-xl border border-gray-200 bg-white p-7 text-center shadow-sm dark:border-slate-700 dark:bg-slate-800">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white">
              ¿Listo para impulsar tu centro fitness?
            </h2>
            <p className="mx-auto mt-2 max-w-2xl text-sm text-gray-600 dark:text-slate-300">
              Conoce FitPro y mejora la administración de tu operación con mayor control, orden y velocidad.
            </p>
            <div className="mt-5 flex flex-wrap justify-center gap-3">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                data-analytics-event="cta_product_open"
                data-analytics-label="FitPro abrir"
                className="inline-flex items-center justify-center rounded-lg bg-emerald-700 px-5 py-3 text-sm font-semibold text-white transition hover:bg-emerald-800"
              >
                Abrir FitPro
              </a>
              <a
                ...
                data-analytics-label="FitPro contacto"
                className="inline-flex items-center justify-center rounded-lg border border-emerald-200 bg-white px-5 py-3 text-sm font-semibold text-emerald-800 transition hover:bg-emerald-50 dark:border-emerald-700 dark:bg-transparent dark:text-emerald-300 dark:hover:bg-emerald-900/20"
              >
                Contáctanos
              </a>
